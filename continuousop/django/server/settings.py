...
# If you want to change a setting in your own local development environment or
# on a test server you're running, please create a file named local_settings.py
# in the continuousop/django/server directory and override any settings you need
# in that file.
