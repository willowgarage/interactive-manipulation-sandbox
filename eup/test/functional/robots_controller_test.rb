...
class RobotsControllerTest < ActionController::TestCase
  ...
  test "should create robot" do
    assert_difference('Robot.count') do
      post :create, robot: { description: @robot.description, locx: @robot.locx, locy: @robot.locy, name: @robot.name }
    end
  ...
  test "should update robot" do
    put :update, id: @robot, robot: { description: @robot.description, locx: @robot.locx, locy: @robot.locy, name: @robot.name }
    assert_redirected_to robot_path(assigns(:robot))
  end
